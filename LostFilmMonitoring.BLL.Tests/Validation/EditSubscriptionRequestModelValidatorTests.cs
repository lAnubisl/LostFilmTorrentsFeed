...
public class EditSubscriptionRequestModelValidatorTests
{
    ...
    {
        var emptyQualityInfo = new SeriesQualityInfo(null, null, null);
        var testSeries = new Series(Guid.Parse("11111111-1111-1111-1111-111111111111"), string.Empty, DateTime.UtcNow, string.Empty, emptyQualityInfo, emptyQualityInfo, emptyQualityInfo);
